...
const constantRouters = {
    ...
    children: [
        ...
        {
            path: '/launch-demo3/achievement-parameters',
            name: 'launch-demo3-achievement-parameters',
            component: RouteView,
            hidden: true,
            meta: { title: '成果参数', keepAlive: true, icon: 'global' },
            children: [
                {
                    path: '/launch-demo3/achievement-parameters/statistical-encapsulation',
                    name: 'launch-demo3-achievement-parameters-statistical-encapsulation',
                    component: () => import('@/view/launch-demo3/annual-declaration/personal-profile-table.vue'),
                    meta: { title: '参数管理', keepAlive: true, icon: 'global' },
                    hidden: true,
                },
                {
                    path: '/launch-demo3/achievement-parameters/personal-statistics-table',
                    name: 'launch-demo3-achievement-parameters-personal-statistics-table',
                    component: () => import('@/view/launch-demo3/annual-declaration/annual-overview-table.vue'),
                    meta: { title: '课题参数设置', keepAlive: true, icon: 'global' },
                    hidden: true,
                },
                {
                    path: '/launch-demo3/achievement-parameters/department-statistics-table',
                    name: 'launch-demo3-achievement-parameters-department-statistics-table',
                    component: () => import('@/view/launch-demo3/annual-declaration/annual-reward-table.vue'),
                    meta: { title: '期刊分类管理', keepAlive: true, icon: 'global' },
                    hidden: true,
                },
                {
                    path: '/launch-demo3/achievement-parameters/teacher-statistics-table',
                    name: 'launch-demo3-achievement-parameters-teacher-statistics-table',
                    component: () => import('@/view/launch-demo3/annual-declaration/annual-auxiliary-table.vue'),
                    meta: { title: '出版社信息', keepAlive: true, icon: 'global' },
                    hidden: true,
                },
                {
                    path: '/launch-demo3/achievement-parameters/department-statistics-table1',
                    name: 'launch-demo3-achievement-parameters-department-statistics-table1',
                    component: () => import('@/view/launch-demo3/annual-declaration/annual-reward-table.vue'),
