...
export default observer({
    ...
    computed: {
        redirectUri() {
            ...
            return `${clientConfigEnv.VUE_APP_WX_REDIRECT_URL}/orp-svr/forget/verifiy-account/wechat-open/${clientConfigEnv.VUE_APP_WX_CODE_APPID}/${this.account.id}?callbackUrl=${callbackUrl}`;
        },
        option() {
            return {
                self_redirect: true,
