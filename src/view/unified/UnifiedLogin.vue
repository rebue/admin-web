        ...
        <div class="w100 flex-box al-c main">
            ...
            <div class="card-shadow of-h login-box">
                <div class="w100 font-22 white flex-box title">
                    <p class="h100 flex-1 flex-box al-c ju-c cu-p" :class="'active'" @click="showBox = 'password'">
                        账号登录
                    </p>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            // 是否启用扫码事件监听
            isListening: false,
            pathPrefix: 'http://127.0.0.1:10080/oap-svr/oap/login',
            // 头部logo
