        ...
        <fragment>
            <base-manager ref="baseManager">
                <template #managerCard>
                    <a-tabs>
                        <a-tab-pane :key="1" tab="马克思主义基础理论研究(科学社会主义)"></a-tab-pane>
                        <a-tab-pane :key="2" tab="马克思主义基础理论研究(哲学经济学)"></a-tab-pane>
                    </a-tabs>
                    <a-row type="flex">
                    ...
                    'list|3-20': [
                        {
                            ...
                            'makeUpExamAchievement1|40-60': 40,
                            'makeUpExamAchievement2|40-60': 40,
                            'usualAchievement|10-20': 20,
                            'attendanceAchievement|5-10': 0,
                            'achievement|20-40': 20,
                            'allMakeUpExamAchievement|100-120': 100,
