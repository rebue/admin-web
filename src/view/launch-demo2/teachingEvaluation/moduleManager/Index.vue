        ...
        const page = function() {
            const p = new Promise(resolve => {
                ...
                const mockList = require('mockjs').mock({
                    ...
                    'list|5': [
                        {
                            'teacherNo|+1': 10000000,
                            'workloadName|+1': ['组织学生进行大扫除', '开展班级文化交流活动', '各班进行一次交流授课'],
                            workloadTime: '@now(yyyy-MM-dd)',
                            department: ['行政部'],
                            createTime: '@now(yyyy-MM-dd)',
                            endTime: '@now(yyyy-MM-dd)',
                            'explain|+1': ['清洁校园，搞好卫生', '促进各班直接师生感情', '对教学质量的探讨'],
                        },
                    ],
                });
                // 数据列表在这里设置
