                        ...
                        <div>
                            ...
                            >
                                <a-form-model :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }">
                                    ...
                                    <a-form-model-item label="对应学员ID:">
                                        <a-select
                                            :default-value="venueId[1]"
                                            style="width: 315px"
                                            @change="handleProvinceChange"
                                        >
                                            <a-select-option v-for="venueId in venueId" :key="venueId">
                                    ...
                                    <a-form-model-item label="选手姓名:">
                                        <a-input placeholder="请输入选手姓名" />
                                    </a-form-model-item>
                                    <a-form-model-item label="选手序号:">
                                        <a-input placeholder="请输入选手序号" />
                                    </a-form-model-item>
                                    <a-form-model-item label="选手说明:">
                                        <a-textarea
                                            placeholder="请输入选手说明"
